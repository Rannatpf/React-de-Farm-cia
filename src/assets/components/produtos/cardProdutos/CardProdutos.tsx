  ...
  return (
    <div className='border-slate-900 border flex flex-col rounded overflow-hidden justify-between'>
      ...
      <div>
        ...
        <div className='p-4 '>
          <h4 className='text-lg font-semibold uppercase'>Principio ativo:</h4>
      ...
      <Link to='' className='w-full text-white bg-indigo-400 hover:bg-indigo-800 flex items-center justify-center py-2'>
        ...
        <Link to='' className='text-white bg-blue-400 hover:bg-blue-700 w-full flex items-center justify-center'>
